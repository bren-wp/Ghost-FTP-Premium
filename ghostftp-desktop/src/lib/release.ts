...
export const PRODUCT_VERSION_DISPLAY = "0.18.0";
export const PRODUCT_VERSION_BADGE = "0.18.0";
export const PRODUCT_BUILD = "2026.09.26.18";
export const PRODUCT_RELEASE_DATE = "26 September 2026";
